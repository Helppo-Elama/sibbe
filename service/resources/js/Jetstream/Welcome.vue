<template>
	<div>
		<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
			...
			<div class="mt-8 text-2xl">Tervetuloa Villa Sibben sivuston hallintaan.</div>
		</div>
		...
		<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
			<div class="p-6">
				<div class="flex items-center">
					...
					<div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">Ohjeita</div>
				</div>

				<div class="ml-12">
					<div class="mt-2 text-sm text-gray-500">
						Tiedot tallentuvat automaattisesti n. 1 sekunnin kuluttua siitä kun tietoa on muutettu.
						Täyttäkää siis tietoja aina rauhallisesti ja odotelkaa täyttämisen jälkeen hetken aikaa
						ennenkuin suljette selaimen tai menette toiselle sivulle.
						<br />
						<br />
						Pääsääntöisesti ne tiedot, jotka on täytetty näkyvät sivuilla. Joitain poikkeuksia voi
						olla esimerkiksi ruoka-annos joka on tyhjä, näkyy myös tyhjänä ruoka-annoksena sivuilla.
						<br />
						<br />
						Tarkistakaa tietojen täytön jälkeen aina vielä itse
						<a
							href="https://sibbe.fi"
							class="underline text-sm text-indigo-600 hover:text-indigo-900"
							>sivustolta</a
						>
						että tiedot näkyvät oikein.
					</div>
				</div>
			</div>
			...
			<div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
				<div class="flex items-center">
					<svg fill="currentColor" viewBox="0 0 24 24" class="w-8 h-8 text-gray-400">
						<path
					...
					<div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">
						<a href="https://laracasts.com">Ohjelmisto</a>
					</div>
				</div>

				<div class="ml-12">
					<div class="mt-2 text-sm text-gray-500">
						Ohjelmistossa voi olla virheitä, jonka johdosta jokin asia ei näy sivuilla niinkuin
						pitää. Olisi siksi hyvä jos virheistä ilmoitettaisiin eteenpäin niin ne saadaan siten
						korjattua.
						<br />
						<br />
						Jos havaitsette ohjelmistossa virheitä tai parannettavaa niin otakaa yhteyttä
						sähköpostilla
						<a
							href="mailto:manne@helppoelama.net"
							class="underline text-sm text-indigo-600 hover:text-indigo-900"
							>manne@helppoelama.net</a
						>
						tai kiireellisissä asioissa puhelimitse
						<a
							href="tel:+358407578626"
							class="underline text-sm text-indigo-600 hover:text-indigo-900"
							>+358 40 757 8626</a
						>.
					</div>
