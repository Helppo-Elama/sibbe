...
namespace App\Http\Controllers\Web\Portions;
...
class PortionController extends Controller
{
    public function post(Request $request)
    {
        if ($request->id) {
            ...
            return response()->json(["message" => "Annoskortti päivitetty"], 200);
        } else {
            $portion = new Portion;
    ...
    public function delete(Request $request)
    {
        ...
        } else return response()->json(["message" => "Listalta ei löytynyt poistettavaa annosta"], 200);
    }
}
