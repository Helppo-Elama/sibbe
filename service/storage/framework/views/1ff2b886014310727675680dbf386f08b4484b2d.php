...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title>Villa Sibbe: Palaute</title>
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 ">
                <div class="text-center pt-8 sm:pt-0">
                    <h1 class=>Saitte palautetta <?php echo e(config("app.name")); ?> sivustolta</h1>
                </div>
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><p class="underline">Lähettäjä:</p></div>
                            </div>
                            <div class="ml-12">
                            ...
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><p class="underline">Viesti:</p></div>
                            </div>
                            <div class="ml-12">
                            ...
                            <div class="flex items-center">
                                <div class="ml-4 text-lg leading-7 font-semibold"><p class="underline">Lähettäjän sähköposti:</p></div>
                            </div>
                            <div class="ml-12">
                                <div class="text-gray-600 dark:text-gray-400 text-sm">
                                    <?php echo e($reply_to); ?>
...
<?php /**PATH C:\Dev\work\sibbe\www\service\resources\views/contact.blade.php ENDPATH**/ ?>