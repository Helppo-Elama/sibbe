		...
		(p, s) => {
			const getPlaceDetails = (
				...
				infowindow.setContent(
					`<div style='font-size: 130%;' class='color-dark'><strong>${place.name}</strong><br><br>${place.formatted_address}<br><br>` +
						`<a class="color-dark" href="https://www.google.com/maps/dir/?api=1&destination=${routeDestination}">Reittiohjeet</a></div>`
				)
...
function googleMapsInitFunction(init: IGoogleMapsInit, loaded: boolean): boolean {
...
export default googleMapsInitFunction
