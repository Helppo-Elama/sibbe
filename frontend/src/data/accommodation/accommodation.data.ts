...
const accommodation: IRooms = {
	rooms: [
		...
		},
		{
			...
			breakpoints: { md: 5 },
			body: "Viehättävä huone kahdelle, lisävuodemahdollisuudella.<br /><br />Olavissa vain erilliset sängyt.<br /><br />Ikkunasta avautuu upea näkymä venesataman suuntaan.",
			equipments: [
				{
					title: "Lisävuodemahdollisuus"
				}
		...
		},
		{
			...
			breakpoints: { md: 5 },
			body: "Kiehtova huone kahdelle, lisävuodemahdollisuudella.<br /><br />Sängyn saa halutessaan parivuoteena tai erillisinä, yhden hengen vuoteina.<br /><br />Ikkunasta avautuu näkymät kartanon pihapiiriin.",
			equipments: [
				{
					title: "Parivuode tai kaksi yksittäistä sänkyä"
				},
		...
		},
		{
			...
			breakpoints: { md: 7 },
			htmlClass: "light-on-red",
			body: "Yläkerran päätyhuone Labra on vieraidemme käytössä.<br /><br />Labrassa on iso pöytä ruokailua tai työskentelyä varten.<br /><br />Lisäksi Labran löytyy astioita ja keittiön tasolta nautittavaksi kahvia ja teetä.",
			equipments: [
				{
					title: "Televisio"
				},
