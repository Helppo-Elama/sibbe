    ...
    <v-container fluid class="pa-0 ma-0">
      ...
      >
        ...
        <v-col
          ...
          md="6"
          lg="4"
          class="d-flex align-center justify-center pb-16"
        >
      ...
      <v-row class="ma-0" justify="center" align="center">
        <v-col
          cols="12"
          md="6"
          class="full-height light-on-red pb-16"
          data-aos="fade-up"
        >
          <h3 class="museo museo-heading pt-16 pb-16">Cafe Sibbe</h3>
          <p>
            ...on Kotoisa rantakahvila Joensuun Tilan satamassa Sipoossa.
            Vieressä aktiviteetteja moneen makuun. Tule viihtymään kanssamme
            pidemmäksikin aikaa!
          </p>
          <p>
            <strong>
        ...
        <v-col
          cols="12"
          md="6"
          class="yellow-on-dark full-height pt-16 pb-16"
          data-aos="fade-up"
        >
          <v-lazy>
            <VueFB :fbUrl="fbUrl" />
...
import {
  cafeImages as images,
  cafeCarouselImages as carouselImages,
