      ...
      <v-row class="ma-0 light-on-green full-height pt-16 pb-16 pl-5 pr-5">
        <v-col cols="12">
          ...
          <p>
            ...
            kautta. Alta voit tarkistaa huonekohtaisen varaustilanteen etukäteen
            sekä siirtyä varausjärjestelmään.
          </p>
        </v-col>
        <v-col cols="12" sm="6">
              ...
              <v-row class="dark-on-light">
                ...
                <v-col cols="12" md="6">
                  ...
                  <div v-else>
                    ...
                    ></v-text-field>
                    <v-btn
                      :disabled="!siteminderLink.show"
                      class="thertiary mt-10"
                    >
                      <a v-if="!siteminderLink.show" :href="siteminderLink.url"
                        >Valitse päivät</a
                      >
...
const contact = Vue.extend({
  ...
  methods: {
    ...
    monthClick(yearAndMonth: string) {
      this.selectedMonth.year = (yearAndMonth?.split(
        "-"
      ...
      if (isISiteminder(data) && isISiteminder(this.siteminder)) {
        ...
        for (const i in room_types) {
          for (const x in room_types[i].room_type_dates) {
            this.siteminder.room_types[i].room_type_dates.push(
              room_types[i].room_type_dates[x]
            );
          }
        }
      }
