        ...
        <v-container fluid>
          <v-row>
            <v-col cols="12" sm="6" md="12" class="vertical-middle">
              <p>
                Huoneet ovat valmiina tulopäivänä klo 15 alkaen ja ne tulee
                luovuttaa läh&shy;tö&shy;päi&shy;vä&shy;nä klo 11 mennessä. Voit
                tehdä suoraan varauksen
                <router-link
                  class="additional color-green animate"
                  to="/siteminder"
                >
                ...
                <br />
                <br />
                Voit myös tiedustella varauksia esimerkiksi pidemmälle
                ajanjaksolle tai muuten erityistoiveilla
                kir&shy;joit&shy;ta&shy;mal&shy;la sähköpos&shy;tia
